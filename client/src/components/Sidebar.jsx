    ...
    <div className="flex flex-col justify-between bg-gray-300 h-full overflow-y-scroll min-w-210 hide-scrollbar">
      <div className="flex flex-col">
        <Link to="/" className="flex px-5 gap-2 my-6 pt-1 w-190 items-center" onClick={handleCloseSidebar} >
          <div className='flex flex-row gap-1 justify-center items-center text-black font-semibold'>
      ...
      {user && (
        <Link to={`user-profile/${user._id}`} className="flex my-5 mb-3 gap-2 p-2 items-center bg-gray-300 rounded-lg shadow-lg mx-3" onClick={handleCloseSidebar}>
